...
return n});var ec=a.jQuery,fc=a.$;return n.noConflict=function(b){return a.$===n&&(a.$=fc),b&&a.jQuery===n&&(a.jQuery=ec),n},typeof b===L&&(a.jQuery=a.$=n),n});var Scripts={_init:function(){this._click()},_click:function(){$(".seta_carousel").click(function(){var a=$(this).hasClass("left"),b=$(this).parent().find(".myCarousel"),c=b.find("ul"),d=c.find("li"),e=d.first(),f=d.last();a?Scripts._infinityGalery("left",c,f,e):Scripts._infinityGalery("right",c,f,e)})},_infinityGalery:function(a,b,c,d){"left"===a?b.prepend(c):b.append(d)}};$(document).ready(function(){Scripts._init()});